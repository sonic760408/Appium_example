...
class AndroidTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        desired_caps['deviceName'] = '3300a6f1bbc2c2a9'
        desired_caps['app'] = PATH(
            './apk/app-release.apk'
        )
        '''
    ...
    def test_find_elements_main(self):
        ...
        self.driver.back()
        sleep(2)
        el = self.driver.find_element_by_id("com.tintin.tintinapp:id/img_btn_shop")
        el.click()
        self.assertIsNotNone(el) #Pass if exist
        self.driver.back()
    ...
    def test_find_elements_member(self):
        ...
        el.click()
        sleep(2)
        el = self.driver.find_element_by_id("com.tintin.tintinapp:id/img_btn_member_ticket")
        el.click()
        self.assertIsNotNone(el) #Pass if exist
        self.driver.back()
        sleep(6)
        el = self.driver.find_element_by_id("com.tintin.tintinapp:id/img_btn_member_red_barcode")
        el.click()
        self.assertIsNotNone(el) #Pass if exist
        sleep(2)
        self.driver.back()
        ...
        self.driver.back()
        sleep(2)
        el = self.driver.find_element_by_id("com.tintin.tintinapp:id/img_btn_red_ecmrp")
        el.click()
        self.assertIsNotNone(el) #Pass if exist
